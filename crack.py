...
# coding=utf-8
# code by Daffa XD
# my facebook ( https://www.facebook.com/AKUN.N00B )
...
╚═════╝ ╚══════╝  ╚═══╝  ╚══════╝ ╚════╝  ╚════╝ 
      ...
      :  \033[1;31mCODE \033[1;36mBY \033[1;33mDAFFA \033[1;34m XD\033[1;37m :     
     ---------------------------------\n'''
...
def license():
	try:
		...
		asup()
	if os.path.exists('license.txt'): #dev DaffaXD
		gagal()
	else:
		asup()
#### ASUP ###
def asup():
    ...
    os.system('am start https://wa.me/6285603036683?text=Hi,%20DaffaXD%20please%20confirm%20my%20key%20Key%20:%20' + id + ' >/dev/null')
    time.sleep(1)
    exit()
### GAGAL ###
def gagal():
    try:
        ...
        if j in r:
            ...
            raw_input('\033[1;97m [\033[1;94m>\033[1;97m] Press Enter To Chat Admin ')
            os.system('am start https://wa.me/6285603036683?text=Hi,+DaffaXD+please+confirm+my+key+Key+:%20' + j + ' >/dev/null')
            exit()
...
def daffa_xd():
	...
	try:
        ...
        print logo
        print "\x1b[1;97m------------------------------------------------------"
        print " [*] Gitbub   :\033[0m https://github.com/DEV588-V1"
